...
# Form implementation generated from reading ui file 'F:\xianyu\moxing\tab3.ui'
#
...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.gridLayout.addWidget(self.BodyLabel_18, 8, 2, 1, 1)
        self.BodyLabel_13 = BodyLabel(self.CardWidget)
        self.BodyLabel_13.setObjectName("BodyLabel_13")
        self.gridLayout.addWidget(self.BodyLabel_13, 6, 0, 1, 1)
        self.BodyLabel_21 = BodyLabel(self.CardWidget)
        self.BodyLabel_21.setObjectName("BodyLabel_21")
        self.gridLayout.addWidget(self.BodyLabel_21, 10, 0, 1, 1)
        self.BodyLabel_19 = BodyLabel(self.CardWidget)
        self.BodyLabel_19.setObjectName("BodyLabel_19")
        self.gridLayout.addWidget(self.BodyLabel_19, 9, 0, 1, 1)
        self.BodyLabel_11 = BodyLabel(self.CardWidget)
        self.BodyLabel_11.setObjectName("BodyLabel_11")
        self.gridLayout.addWidget(self.BodyLabel_11, 5, 0, 1, 1)
        self.BodyLabel_2 = BodyLabel(self.CardWidget)
        self.BodyLabel_2.setObjectName("BodyLabel_2")
        self.gridLayout.addWidget(self.BodyLabel_2, 0, 2, 1, 1)
        self.BodyLabel_22 = BodyLabel(self.CardWidget)
        self.BodyLabel_22.setObjectName("BodyLabel_22")
        self.gridLayout.addWidget(self.BodyLabel_22, 10, 2, 1, 1)
        ...
        self.gridLayout.addWidget(self.BodyLabel_16, 7, 2, 1, 1)
        ...
        self.BodyLabel_20.setText("")
        self.BodyLabel_20.setObjectName("BodyLabel_20")
        self.gridLayout.addWidget(self.BodyLabel_20, 9, 2, 1, 1)
        ...
        self.gridLayout.addWidget(self.BodyLabel_17, 8, 0, 1, 1)
        self.BodyLabel_14 = BodyLabel(self.CardWidget)
        self.BodyLabel_14.setObjectName("BodyLabel_14")
        self.gridLayout.addWidget(self.BodyLabel_14, 6, 2, 1, 1)
        self.BodyLabel_12 = BodyLabel(self.CardWidget)
        self.BodyLabel_12.setObjectName("BodyLabel_12")
        self.gridLayout.addWidget(self.BodyLabel_12, 5, 2, 1, 1)
        self.BodyLabel_15 = BodyLabel(self.CardWidget)
        self.BodyLabel_15.setObjectName("BodyLabel_15")
        self.gridLayout.addWidget(self.BodyLabel_15, 7, 0, 1, 1)
        self.LineEdit_7 = LineEdit(self.CardWidget)
        self.LineEdit_7.setObjectName("LineEdit_7")
        self.gridLayout.addWidget(self.LineEdit_7, 5, 1, 1, 1)
        self.LineEdit_8 = LineEdit(self.CardWidget)
        ...
        self.LineEdit_12 = LineEdit(self.CardWidget)
    ...
    def retranslateUi(self, Form):
        ...
        self.BodyLabel_13.setText(_translate("Form", "有效上覆压力"))
        self.BodyLabel_21.setText(_translate("Form", "地表峰值加速度"))
        self.BodyLabel_19.setText(_translate("Form", "震级"))
        self.BodyLabel_11.setText(_translate("Form", "总上覆压力"))
        self.BodyLabel_2.setText(_translate("Form", "m"))
        self.BodyLabel_22.setText(_translate("Form", "g"))
        ...
        self.BodyLabel_14.setText(_translate("Form", "kPa"))
        self.BodyLabel_12.setText(_translate("Form", "kPa"))
