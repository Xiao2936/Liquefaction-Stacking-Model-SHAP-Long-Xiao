...
class Ui_Form(object):
    ...
    def retranslateUi(self, Form):
        ...
        self.TitleLabel.setText(_translate("Form", "模型三-深度神经网络"))
...
class New_tab3(QFrame):

    def __init__(self):
        super(New_tab3, self).__init__()
        self.ui = Ui_Form()
    ...
    def dz(self):
        ...
        x6 = float(self.ui.LineEdit_7.text())
        x7 = float(self.ui.LineEdit_8.text())
        x8 = float(self.ui.LineEdit_9.text())
        x9 = float(self.ui.LineEdit_10.text())
        x10 = float(self.ui.LineEdit_11.text())
        x11 = float(self.ui.LineEdit_12.text())
        res = dz3(x1,x2,x3,x4,x6,x7,x8,x5,x9,x10,x11)
